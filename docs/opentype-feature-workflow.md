...
2. 擴充 raw `.fea` classifier
   ...
   - 更完整的 markClass / mark positioning 變體，例如 glyph class markClass。
   - 更完整的 GDEF table block，例如 mark glyph sets。
